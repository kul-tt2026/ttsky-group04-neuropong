module red_render (h_count, v_count, draw_red);
 ...
 */
 ...
 wire [1:0] char_index = rel_x[4:3]; // 0=R, 1=E, 2=D
 ...
 always @(*) begin
    ...
    assign draw_red = in_bounds && row_bits[7 - char_x];
endmodule
